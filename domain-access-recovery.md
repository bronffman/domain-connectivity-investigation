...
Наличие записи шлюза по умолчанию и ARP-разрешения подтверждало работоспособность локального L2/L3-соединения до шлюза.
...
Основной причиной являлась некорректная статическая конфигурация сетевого адаптера, не соответствовавшая параметрам используемого сетевого сегмента:

- отсутствовали внутренние DNS-серверы организации;
- параметры IPv4 не соответствовали используемому сетевому сегменту;
- рабочая станция использовала отличающуюся от исправных рабочих мест сетевую конфигурацию;
- вследствие этого не выполнялось разрешение доменных имен и обнаружение контроллера домена.
