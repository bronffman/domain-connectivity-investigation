...
Поскольку компьютер находился в закрытом контуре и не имел доступа к доменной инфраструктуре, при открытии свойств сетевого адаптера Windows не могла проверить доменные учетные данные и запрашивала локальную административную учетную запись данного ПК.
